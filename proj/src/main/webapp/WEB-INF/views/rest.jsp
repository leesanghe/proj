...
<div id="shell">
  <div id="header">
    ...
    <div id="navigation">
      <ul>
        <li><a class="active" href="${pageContext.request.contextPath}/home">메인</a></li>
        <li><a href="#">게시판</a></li>
        <li><a href="#">식당추가</a></li>        
  ...
  <div id="main">
    <div id="content">
      <div class="box">
        <div class="head">
          <h2>유성구</h2>
          <p class="text-right"><a href="#">전체보기</a></p>
        </div>
        <div class="movie">
          <div class="movie-image"> <span class="play"><span class="name">X-MAN</span></span> <a href="#"><img src="css/images/under.jpg" alt="" /></a> </div>
          <div class="rating">
            <p>RATING</p>
            <div class="stars">
